...
const task16data: TaskData = {
    title: 'SSL MITM',
    description:'You followed a link from an ad and this warning showed up. Take appropriate actions.',
    instructions:'Take appropriate actions.',
    setting: 'You followed a link from an ad and this warning showed up. Take appropriate actions.',
    screens: {
        mitm: {
                ...
                //back to safety
                {
                    ...
                    onClick: ({dispatch}) => {
                        dispatch(gameActions.openFeedbackDialog({
                            ...
                            text: "Good! This site does not have appropriate security measures implemented, it is better to not visit such sites."
                        }));
        ...
        mitm2: {
            ...
            buttons: [
                ...
                //back to safety
                {"position":{"top":"69.25%","left":"63.14%"},"size":{"height":"4.11%","width":"8.13%"}},
                //proceed anyway
                {
                    ...
                    onClick: ({dispatch}) => {
                        dispatch(gameActions.openFeedbackDialog({
                            next:{taskId: 17, screenId: 'movies'},
                            text: "Be careful! This site does not have appropriate security measures implemented, it is better to not visit such sites."
                        }));
                        dispatch(gameActions.updatePoints({points:-10}))
                    }
                }
